...
export class PiedraService {
  ...
  piedras = signal<Piedra[]>([
    { id: 'cuazo-rosa-20', nombre: 'Cuarzo Rosa', descripcion: 'Cuarzo', categoriaNombre: 'calibrada', calibreMm: 20, precio: 4500, imagen: 'catalogo-piedras/cuarzo-rosa.jpg' },
    { id: 'cuarzo-rutilado-18', nombre: 'Cuarzo Rutilado', descripcion: 'Cuarzo', categoriaNombre: 'calibrada', calibreMm: 18, precio: 4200, imagen: 'catalogo-piedras/cuarzo-rutilado.jpg' },
    { id: 'haoliotis-01', nombre: 'Haliotis', descripcion: 'Otras piedras', categoriaNombre: 'calibrada', precio: 2800, imagen: 'catalogo-piedras/Haliotis.jpg' },
    ...
    { id: 'lapizlasuli-16', nombre: 'Lapizlasuli', descripcion: 'Lapislazuli', categoriaNombre: 'calibrada', calibreMm: 16, precio: 5200, imagen: 'catalogo-piedras/lapizlasuli.jpg' },
    ...
    { id: 'obsidiana-plateada-7', nombre: 'Obsidiana Plateada', descripcion: 'Obsidiana', categoriaNombre: 'calibrada', precio: 2500, imagen: 'catalogo-piedras/obsidiana-plateada.jpg' },
    { id: 'obsidiana-plateada-1', nombre: 'Obsidiana Plateada', descripcion: 'Obsidiana', categoriaNombre: 'calibrada', precio: 2500, imagen: 'catalogo-piedras/obsidiana-plateada2.jpg' },
  ]);
}
